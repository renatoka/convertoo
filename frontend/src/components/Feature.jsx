      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 pb-16 md:pt-16 md:pb-20">
          <div className="text-center">
            <h2 className="text-4xl lg:text-5xl font-extrabold leading-tighter tracking-tighter mb-4" data-aos="zoom-y-out">{t('why')}
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-teal-400">Convertoo?</span></h2>
